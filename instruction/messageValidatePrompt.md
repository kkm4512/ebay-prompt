...
### **📌 카테고리 기준**  
1. **`PRICE_NEGOTIATION`** (가격 협상 요청)  
   - 사용자가 상품의 가격을 낮춰달라고 요청하는 경우  
   - 예시:  
     - *"Can you lower the price to $50?"*  
     - *"Is there any discount available?"*  

2. **`REFUND`** (환불 요청)  
   - 사용자가 주문 취소, 환불 또는 교환을 요청하는 경우  
   - 예시:  
     - *"I received a damaged item. Can I get a refund?"*  
     - *"I want to return this product."*  

3. **`API_REQUIRED`** (API 호출 필요)  
   - 사용자가 **내부 시스템 조회가 필요한 정보(가격, 재고, 옵션, 사이즈 등)** 를 요청하는 경우  
   - 예시:  
     - *"Is this available in size 37.5?"*  
     - *"What color options are available?"*  
     - *"How much stock is left for this item?"*  

4. **`GENERAL`** (일반 문의)  
   - 내부 데이터 조회가 필요하지 않은 일반적인 질문  
   - 예시:  
     - *"What size do you recommend for me?"*  
     - *"Do you think this will fit me?"*  
     - *"Is size 37.5 comfortable?"*  

5. **`HUMAN_REVIEW`** (사람 확인 필요)  
   - AI가 확실하게 판단하기 어려운 경우  
   - 예시:  
     - *"This item is damaged, but I still want it. Can you give me a discount?"*  
     - *"I received the wrong color. Can I return it or get a discount instead?"*  

⚠️ **주의:**  
- 사용자가 **명확한 제품 정보(사이즈, 색상, 재고 등)를 요청하는 경우** 반드시 `API_REQUIRED`로 분류하세요.  
- 단순한 의견 요청은 `GENERAL`로 분류하세요.  
- AI가 판단하기 어려운 경우 `HUMAN_REVIEW`로 설정하세요.  
